...
export default function TopBar({ onMenuClick }: TopBarProps) {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-surface-border bg-surface-card/95 px-4 py-3 backdrop-blur-md sm:px-6">
      <div className="flex min-w-0 items-center justify-between gap-3">
        <div className="flex min-w-0 items-center gap-3">
          <button
            ...
            onClick={onMenuClick}
            className="flex size-10 shrink-0 items-center justify-center rounded-lg border border-surface-border bg-surface-elevated text-ink-primary transition-colors hover:bg-surface-hover lg:hidden"
          >
            <Menu size={20} />
          </button>
        ...
        <div className="flex shrink-0 items-center gap-2 sm:gap-3">
          <Link to="/wallet" aria-label="Wallet balance">
            <motion.div
              ...
              className="flex min-h-9 items-center gap-2 rounded-lg border border-surface-border bg-surface-elevated px-2.5 transition-colors hover:border-primary/30 sm:px-3"
            >
          ...
          <button
            ...
            className="relative flex size-10 items-center justify-center rounded-lg text-ink-secondary transition-colors hover:bg-surface-hover hover:text-ink-primary"
          >
            <Bell size={18} />
